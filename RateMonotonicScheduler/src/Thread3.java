...
public class Thread3 extends Thread{
	...
	Thread3(Semaphore sema, MainScheduler schedule) {
	...
	public void run() {
		...
		while(true) {
			...
			//Test 4 case change i to 300000 for Thread 3 to run 8 times and have 1 overrun
	...
	public void start() {
		...
		Thread thread = new Thread(new Thread3(this.semaphore, this.scheduler));
		thread.start();
	}
