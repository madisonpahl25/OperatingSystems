...
public class Thread1 extends Thread {
	...
	Thread1(Semaphore sema, MainScheduler schedule) {
	...
	public void run() {
		...
		while(true) {
			...
			//Test 4 case change i to 20000 for Thread 1 to run 78 times and have 1 overrun
	...
	public void start() {
		...
		Thread thread = new Thread(new Thread1(this.semaphore, this.scheduler));
		thread.start();
	}
